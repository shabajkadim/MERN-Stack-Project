      ...
      <div className="pt-20 bg-slate-100 p-2:p-4 min-h-0 min-h-[650px]">
        ...
        {productCartItem[0] ?
          <div className="mt-4 ml-2 md:flex  ">
            ...
            <div className="ml-auto w-96  rounded  mr-6">
              <div className="bg-blue-600 text-white font-bold py-3 px-5 text-lg ">
                Summary
              </div>
          ...
          <div className="flex flex-col w-96 m-auto">
            <p><img src="https://bexcart.com/assets/images/empty-cart.gif"  className=""/></p>
